...
export const logInGrist = createServerOnlyFn(
  async (tableKey: keyof typeof gristTables, data: unknown[]) => {
    try {
      await httpClient({
        method: "POST",
...
export const readFromGrist = createServerOnlyFn(
  async (tableKey: keyof typeof gristTables) => {
