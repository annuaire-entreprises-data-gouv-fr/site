...
function RouteComponent() {
  return (
    <TextWrapper>
      ...
      <p>
        L’Annuaire des Entreprises est mis à disposition du grand public pour
        les informations et données ouvertes au sens du livre III du code des
        relations entre le public et l’administration (CRPA). Cette utilisation
        est libre et gratuite.
      </p>
      <p>
        Pour les données soumises à un secret, au sens des articles L. 311-5 et
        L. 311-6 du CRPA, l’affichage est subordonné à l’utilisation d’un compte
      ...
      <p>
        Pour accéder à l’espace « agent public », l’utilisateur ou
        l’utilisatrice s’authentifie et se connecte à depuis le fournisseur
        d’identité ProConnect.
      </p>
      <p>
        Le service ne propose aucun autre mode d’accès à cet espace agent
        public.
      </p>
      <p>
      ...
      <h3>
        4.2 Accès aux informations légales des sociétés, associations et
        services publics
      </h3>
      <p>
      ...
      <p>
        Le service est mis à disposition par la DINUM pour simplifier l’accès
        des agents publics aux informations relatives aux administrations,
        entreprises et associations.
      </p>
      <p>
        L’utilisateur ou l’utilisatrice s’assure de garder secret son accès au
        service ProConnect. Toute divulgation du mot de passe de cet accès,
        quelle que soit sa forme, est interdite. Il ou elle assume les risques
        liés à l’utilisation de son identifiant et mot de passe ProConnect.
      </p>
      <p>
      ...
      <p>
        Les éventuelles extractions de données et informations accessibles
        depuis l’espace « agent public » doivent être réalisées dans des
        conditions garantissant leur intégration, sécurité et confidentialité.
        Cette obligation perdure aussi longtemps que les informations ou données
        sont protégées par un secret.
      </p>
      ...
      <p>
        ...
        espace « agent public », l’utilisateur ou l’utilisatrice doit déclarer
        un cas d’usage nécessitant cet accès. Dans ce cadre, il est rappelé que
      ...
      <p>
        La DINUM s’engage à la sécurisation de la plateforme, notamment en
        prenant toutes les mesures nécessaires permettant de garantir la
        sécurité et la confidentialité des informations fournies depuis la
      ...
      <p>
        ...
        public » d’utilisateur ou d’utilisatrice du service qui aurait méconnu
        les présentes modalités d’utilisation et à en informer son employeur,
        sans préjudice des éventuelles actions en responsabilité pénale et
      ...
      <p>
        Les termes des présentes modalités d’utilisation peuvent être modifiés
        ou complétés à tout moment, sans préavis, en fonction des modifications
        apportées au service, de l’évolution de la législation ou pour tout
        autre motif jugé nécessaire. Ces modifications et mises à jour
        s’imposent à l’utilisateur ou l’utilisatrice qui doit, en conséquence,
        se référer régulièrement à cette rubrique pour vérifier les conditions
      ...
      <p>
        ...
        d’accéder à un contenu ou à un des services et que vous n’avez pas
        obtenu de réponse satisfaisante de notre part, vous pouvez :
      </p>
      <ul>
        <li>
