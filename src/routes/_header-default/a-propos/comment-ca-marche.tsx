    ...
    <TextWrapper>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            Informations sur les <strong>dirigeants</strong> (d’entreprises) ou
            élus (collectivités)
          </li>
          <li>
          ...
          <li>
            <strong>Annonces légales :</strong> annonces officielles au Journal
            Officiel et au BODACC (Bulletin Officiel Des Annonces Civiles et
            Commerciales)
          </li>
          <li>
        ...
        <p>
          ...
          publiques, accessibles librement et gratuitement. On appelle cela des
          données ouvertes ou open data.
        </p>
        <p>
          Ces bases de données sont récupérées grâce aux téléservices développés
          par les <Link to="/administration">administrations partenaires</Link>{" "}
          :
        </p>
        <ul>
        ...
        <h2>
          A quel point les données utilisées par l’Annuaire des Entreprises sont
          ouvertes et disponibles ?{" "}
        </h2>
        <p>
          Toutes les données utilisées sont ouvertes en open data et accessibles
          sur{" "}
          <a
        ...
        <p>
          ...
          <Link to="/donnees/sources">sources de données</Link> de l'Annuaire et{" "}
          <Link to="/donnees/api">statut des API utilisées</Link>.
        </p>
        <p>
          <strong>NB</strong> : L’Annuaire des Entreprises a développé sa propre
          API pour son moteur de recherche et la met également à disposition
          gratuitement :{" "}
          <a
        ...
        <p>
          Découvrez notre <Link to="/partager">guide sur le sujet</Link> et
          n'hésitez pas à nous contacter afin que nous puissions vous aider via
          notre{" "}
        ...
        <p>
          L’Annuaire des Entreprises est un des services clefs mis en œuvre par
          l’Etat pour faciliter les démarches des entreprises. Parmi ses
        ...
        <ul>
          <li>
            ...
            <strong>numéro SIRET, numéro SIREN, numéro de TVA etc.</strong> afin
            de les utiliser dans leurs démarches administratives.
          </li>
          <li>
          ...
          <li>
            Permettre à tout un chacun de vérifier qu’une entreprise existe, de
            consulter ses informations et de lutter contre la fraude. En cas de
            problème, contactez les services de la{" "}
            <a
