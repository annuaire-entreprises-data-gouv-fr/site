...
import { AccessibleTable as FullTable } from "#/components/table/accessible";
...
export const Route = createFileRoute("/_header-default/a-propos/budget")({
  head: () => {
    const canonical =
      "https://annuaire-entreprises.data.gouv.fr/a-propos/budget";
    return {
      meta: meta({
    ...
    <div>
      <TextWrapper>
        ...
        <p>
          ...
          <Link to="/lp/agent-public">compte pour les agents publics</Link>. Ce
        ...
        <p>
          ...
          <Link to="/a-propos/stats">page de statistiques</Link>.
        </p>
      </TextWrapper>
    </div>
  );
