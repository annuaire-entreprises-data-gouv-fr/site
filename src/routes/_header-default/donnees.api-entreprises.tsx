  ...
  return (
    <div className="content-container">
      ...
      <p>
        ...
        <Link search={{ name: "edf" }} to="/rechercher">
          page de recherche
        </Link>{" "}
        et celles de la{" "}
        <Link
          params={{ slug: "electricite-de-france-edf-552081317" }}
          to="/entreprise/$slug"
        >
          fiche résumé
        </Link>
      ...
      <p>
        ...
        <Link to="/administration">administrations compétentes</Link>.
        <br />
      </p>
      <p>
        La liste des données et des API utilisées par le site est disponible sur
        la page <Link to="/donnees/sources">source de données</Link>.
      </p>
      ...
      <p>
        ...
        savoir plus,{" "}
        <Link to="/lp/agent-public">découvrez l'espace agent public</Link>.
      </p>
      <ul>
        <li>
          Conditions d’accès :{" "}
