...
export const Route = createFileRoute("/_header-default/vie-privee")({
  head: () => {
    const canonical = "https://annuaire-entreprises.data.gouv.fr/vie-privee";
    return {
      meta: meta({
  ...
  return (
    <TextWrapper>
      ...
      <p>
        ...
        associations et services publics en France. Ce service traite des
      ...
      <ul>
        <li>
          Agréger et diffuser les informations légales publiques des
          entreprises, associations et services publics en France ;
        </li>
        <li>
      ...
      <div className="fr-table">
        <table>
          ...
          <tbody>
            <tr>
              <td>
                Données relatives aux représentants des entreprises,
            ...
            <tr>
              <td>
                Données relatives aux agents publics accédant au service
      ...
      <p>
        Les données des dirigeants et des bénéficiaires effectifs sont
        collectées via les services suivants : Institut national de la
        statistique et des études économiques (Insee), Institut national de la
        propriété industrielle (INPI), la Direction de l’information légale et
        administrative (DILA). Pour plus d’informations, voir{" "}
      ...
      <p>
        ...
        octobre 2019 relatif au système d’information et de communication de
        l’Etat et à la direction interministérielle du numérique, notamment son
        article 6.
      </p>
      ...
      <p>
        ...
        Entreprises sont supprimées des serveurs au bout d’une dizaine de
        minutes.
      </p>
      ...
      <p>
        ...
        <Link to={constants.links.parcours.contact}>formulaire de contact</Link>
        .
      </p>
      <p>Ou bien à :</p>
      <ul>
