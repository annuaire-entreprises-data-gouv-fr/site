...
export const searchQueryParamsSchema = z.object({
  ...
  n: queryString.catch(""),
  naf: queryString.or(z.array(queryString)).catch(""),
  nature_juridique: queryString.or(z.array(queryString)).catch(""),
  tranche_effectif_salarie: queryString.or(z.array(queryString)).catch(""),
  categorie_entreprise: queryString.or(z.array(queryString)).catch(""),
  sap: queryString.or(z.array(queryString)).catch(""),
