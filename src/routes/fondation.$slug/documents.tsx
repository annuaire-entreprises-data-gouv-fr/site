...
export const Route = createFileRoute("/fondation/$slug/documents")({
  ...
  head: ({ loaderData }) => {
    ...
    const canonical = `https://annuaire-entreprises.data.gouv.fr/fondation/${fondation.id}/documents`;
    return {
      meta: meta({
        title: `Documents, Actes et statuts - ${fondationPageTitle(fondation)}`,
