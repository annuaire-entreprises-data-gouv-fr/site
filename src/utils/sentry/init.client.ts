import { type ErrorEvent, init } from "@sentry/tanstackstart-react";
import { createClientOnlyFn } from "@tanstack/react-start";
import isUserAgentABot from "../user-agent";
import { isSentryActivated } from ".";
import { getTransactionNameFromUrl } from "./tracing";
...
export const initSentryClient = createClientOnlyFn(() => {
  ...
  init({
    ...
    beforeSend(event, hint) {
      ...
      // TODO use once model is defined
