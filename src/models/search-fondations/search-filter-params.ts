...
// TODO update this to match the API Recherche Fondations params
...
class SearchFondationsFilterParams {
  ...
  toApiURI() {
    ...
    return serializeParams({
      ...
      est_finess: labels.includes("finess"),
  ...
  extractFilters = (
    ...
    const structureLabels: Record<string, string> = {
      ...
      finess: "Label : Établissement Sanitaire et Social",
...
export default SearchFondationsFilterParams;
