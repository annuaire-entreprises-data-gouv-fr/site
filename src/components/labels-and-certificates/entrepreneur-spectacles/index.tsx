...
export const CertificationsEntrepreneurSpectaclesSection: React.FC<{
  ...
  >
    {(entrepreneurSpectacles) => (
      <>
        Cet organisme déclare exercer une activité d’entrepreneur de spectacles
        vivants, à titre principal ou occasionnel. Cette activité ne peut être
        exercée qu’en cas de détention de licence d’entrepreneur de spectacles
        vivants (récépissé de déclaration au statut « valide »), sauf exceptions
        suivantes : moins de 7 spectacles par an sont organisés et soit
        l’activité principale n’est pas le spectacle soit l’organisme est un
        groupement d’artistes amateurs.
        <br />
        <br />
        ...
        catégorie de licence indiquée par le préfixe du numéro indique le métier
        pour lequel la licence est accordée (exploitant de lieu, producteur,
        diffuseur, tourneur).
        <br />
        <br />
        ...
        <br />
        Pour toute question concernant le contenu de votre déclaration veuillez
        consulter la direction des affaires régionales de votre établissement
        principal.
        <br />
