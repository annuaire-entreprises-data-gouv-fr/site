    ...
    >
      <div className="content-container text-wrapper">
        ...
        <ul>
          <li>
            <a href="#qr">
              Générer un lien scannable vers une fiche entreprise
            </a>
          </li>
          <li>
            <a href="#link">
        ...
        <div>
          <h2 id="qr">Générer un lien scannable vers une fiche entreprise</h2>
          <h3>Quand l’utiliser ?</h3>
          <p>
            En ajoutant un lien scannable sur un document papier (facture,
            courier etc.), n’importe qui peut retrouver la fiche d’une
            entreprise en prenant en photo et en scannant le lien.
          </p>
          <p>Voici un exemple de lien scannable :</p>
          <img alt="exemple de QR code" src="/images/QR_code_example.jpeg" />
          <h3>Comment générer un lien scannable ?</h3>
          <p>
