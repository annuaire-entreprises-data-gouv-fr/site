...
export const renderPage = (body: string) => {
  ...
  <html lang="en">
    ${head}
    <body>
      <style>div.body-wrapper { margin-top:40px; margin-bottom:50px; } h1 { margin-top:20px; font-size: 1.8rem; } div.body-wrapper a:not(.fr-breadcrumb__link) { line-height:1.8rem; } .pagination > a { margin:5px; display: inline-block; }</style>
