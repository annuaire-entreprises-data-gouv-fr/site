            ...
            <div className="fr-header__body">
              <div className="fr-container">
                <div className="fr-header__body-row">
                  ...
                  >
                    <div
                      className="fr-header__brand-top  fr-enlarge-link"
                      style={{
                        marginRight: '15px',
                      }}
                    >
                      <div className="fr-header__logo">
                        <a
                          href="/"
                          title="Accueil - L’Annuaire des Entreprises"
                        >
                          <p className="fr-logo">
                            République
                            <br />
                      ...
                      {useSearchBar || useLogo ? (
                        ...
                        >
                          <svg
                            width={140}
                            aria-label="Annuaire des Entreprises"
                            height={54}
                            fill="none"
                  ...
                  <aside className="fr-header__tools">
