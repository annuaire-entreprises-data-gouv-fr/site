        ...
        <ul>
          <li>
            <Icon color={constants.colors.frBlue} slug="mapPin">
              <strong>Zone géographique&nbsp;:</strong>&#8200;filtrez par ville,
          ...
          <li>
            <Icon slug="file">
              <strong>Situation administrative&nbsp;:</strong>&#8200;filtrez par
              domaine d’activité, état administratif (En activité/Cessée) ou
              taille d’entreprise
            </Icon>
          </li>
        </ul>
