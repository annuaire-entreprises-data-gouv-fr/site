export enum APIRoutesPaths {
  ...
  EspaceAgentProbtp = 'espace-agent/probtp',
  ...
  EspaceAgentBanqueDeFranceBilansProtected = 'espace-agent/banque-de-france-bilans-protected',
  EspaceAgentDgfipChiffreAffairesProtected = 'espace-agent/dgfip-chiffre-affaires-protected',
  EspaceAgentDgfipLiassesFiscalesProtected = 'espace-agent/dgfip-liasses-fiscales-protected',
  EspaceAgentRcpEffectifsAnnuelsProtected = 'espace-agent/rcp-effectifs-annuels-protected',
