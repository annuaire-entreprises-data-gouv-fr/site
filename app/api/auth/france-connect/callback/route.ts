...
// Note: Due to HTTPS constraints, direct redirection will not work, but you can manually replace staging.annuaire-entreprises.data.gouv.fr with localhost:3000 in your browser to continue testing.
