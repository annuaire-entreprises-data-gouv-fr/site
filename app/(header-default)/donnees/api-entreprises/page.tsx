...
export default async function AccesByAPIPage() {
  return (
    <>
      <div className="content-container">
        ...
        <p>
          ...
          National des Entreprises (RNE) et la base Sirene). Elle permet
          d’accéder aux principales données ouvertes des entreprises françaises.
          Elle contient par exemple les données de la{' '}
        ...
        <p>
          La liste des données et des API utilisées par le site est disponible
          sur la page <a href="/donnees/sources">source de données</a>.
        </p>
        ...
        <p>
          ...
          haut niveau d’habilitation. Ses données sont accessibles sur
          l’Annuaires des Entrepirses, uniquement{' '}
          <strong>aux agents publics</strong>. Pour en savoir plus,{' '}
        ...
        <p>
          ...
          particulier, il existe deux API pour accèder aux deux principales
          bases de données d’entreprises :
        </p>
        <ul>
          <li>
            l’<a href="https://api.gouv.fr/les-api/sirene_v3">API Sirene</a> de
            l’
