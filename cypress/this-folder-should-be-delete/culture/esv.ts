...
export const esv = {
  ...
  parameters: {
    ...
    q: 'siren_personne_physique_siret_personne_morale=842019051 OR (siren_personne_physique_siret_personne_morale > 84201905100000 AND siren_personne_physique_siret_personne_morale < 84201905199999)',
    rows: 10,
    start: 0,
  ...
  records: [
    {
      ...
      fields: {
        ...
        categorie: 2,
        date_de_depot_de_la_declaration_inscrite_sur_le_recepisse: '2021-11-30',
      ...
      geometry: { type: 'Point', coordinates: [2.34785432498, 48.8923628559] },
      record_timestamp: '2023-03-20T05:32:36.1Z',
    },
  ],
};
