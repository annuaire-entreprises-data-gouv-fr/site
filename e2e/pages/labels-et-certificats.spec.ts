...
test.describe("Label et certificats", () => {
  test.describe("QUALIBAT-RGE", () => {
    test("Should display QUALIBAT-RGE", () => {
  ...
  test.describe("ESS & Spectacles vivants", () => {
    test("Should display ESS and spectacles vivants", () => {
  ...
  test.describe("Professionnel du Bio", () => {
    test("Should display Professionnel du Bio", () => {
  ...
  test.describe("Entreprise Sociale Inclusive", () => {
    test("Should display Entreprise Sociale Inclusive", () => {
  ...
  test.describe("Egapro", () => {
    test("Should display Égalité professionnelle - Egapro", () => {
