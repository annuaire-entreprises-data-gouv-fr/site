...
test.describe("Documents ESSOR ENERGIES (SOLARSUD)", () => {
  ...
  test("[LOGGED] Should display documents", () => {
    cy.login();
    cy.visit("/documents/487444697");
    cy.wait(1000);
    // Conformité
  ...
  test("[LOGGED] Should not display conformite documents but travaux publics documents", () => {
  ...
  test("[LOGGED] Should display conformite sociale documents but not fiscale and travaux publics documents", () => {
  ...
  test("[LOGGED] Should display conformite fiscale documents but not sociale and travaux publics documents", () => {
